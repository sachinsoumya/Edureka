...
export const User = () => {
  const data = [
    ...
    {
      name: 'Peter',
      pic: ' https://media.istockphoto.com/id/1139459625/photo/silhouette-of-man-in-dark-place-anonymous-backlit-contour-a.jpg?b=1&s=170667a&w=0&k=20&c=FvcYQyr8xlRzVHrYb3IsksCwDfTucVTQfOM_kq7whHI='
    },
    {
      name: 'John',
    ...
    {
      name: 'Gopal',
      pic: 'https://media.istockphoto.com/id/1386479313/photo/happy-millennial-afro-american-business-woman-posing-isolated-on-white.jpg?b=1&s=170667a&w=0&k=20&c=ahypUC_KTc95VOsBkzLFZiCQ0VJwewfrSV43BOrLETM='
    }
  ];
  return (
    <div>
